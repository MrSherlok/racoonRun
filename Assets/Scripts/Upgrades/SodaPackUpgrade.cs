...
public class SodaPackUpgrade : DefUpgradeParrent {
	...
	void Start() {
		...
		_defCountLvl = PlayerPrefs.GetInt ("SodaCountLvl");
		...
		_defRestoreTimeLvl = PlayerPrefs.GetInt ("SodaRestoreTimeLvl");
		...
		_defRestoreSpeedLvl = PlayerPrefs.GetInt ("SodaRestoreSpeedLvl");
		...
		_defSpecialLvl = PlayerPrefs.GetInt ("SodaSpecialLvl");
	...
	if (GoldScript.Gold >= defCountNeedGold [0] && _defCountLvl == 0) {
		...
		_defCountLvl = 1;
			PlayerPrefs.SetInt ("SodaCountLvl", _defCountLvl);
		}
	}
	...
	public override void DefRestoreTime1 ()
	{
		if (GoldScript.Gold >= defRestoreTimeNeedGold [0] && _defRestoreTimeLvl == 0) {
			...
			PlayerPrefs.SetInt ("SodaRestoreTimeLvl", _defRestoreTimeLvl);
		}
	}
	...
	public override void DefRestoreSpeed1 ()
	{
		if (GoldScript.Gold >= defRestoreSpeedNeedGold [0] && _defRestoreSpeedLvl == 0) {
			...
			PlayerPrefs.SetInt ("SodaRestoreSpeedLvl", _defRestoreSpeedLvl);
		}
	}
	...
	public override void Special1 ()
	{
		if (GoldScript.Gold >= defSpecialNeedGold [0] && _defSpecialLvl == 0) {
			...
			_defSpecialLvl = 1;
			PlayerPrefs.SetInt ("SodaSpecialLvl", _defSpecialLvl);
		}
	}
